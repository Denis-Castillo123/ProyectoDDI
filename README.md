...
|  HU04  | Yo como persona con problemas visuales y de salud, requiero poder detectar cuando está oscureciendo para ello necesito un componente para el caso de que este oscureciendo mas alla de lo que mi vista puede percibir | Debe | 3 | El usuario recibirá  un mensaje por medio en el dispositivo de la mano para dar a conocer el si se encuentra oscuro o no  | Denisse | Sprint 1 |
