...
|  HU07 | Yo como persona con problemas de visuales, requiero que tener un medio visual donde se vea reflejada la temperatura ambiental| Debe | 5 | Se podrá visualizar la medición de la temperatura del ambiente por medio de mensajes en la pantalla integrada en el dispositivo del antebrazo. | Denis | Sprint 2 |
