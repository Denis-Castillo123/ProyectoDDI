...
|  HU09  | Yo como persona con problemas de visión, requiero que un ventilador me refresque al momento de que detecte que como persona estoy avanzando demasiado rápido.| Debe | 1 | Se podrá detener la alerta de un objeto cercano por medio de un botón integrado en el dispositivo de la muñeca. | Diego | Sprint 1 |
