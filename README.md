...
|11|Giroscopio o Acelerómetro |Unidad de medición inercial o IMU (Inertial Measurment Units) de 6 grados de libertad (DoF) pues combina un acelerómetro de 3 ejes y un giroscopio de 3 ejes. Este sensor es muy utilizado en navegación, goniometría, estabilización, etc.|<img src="https://naylampmechatronics.com/763-large_default/modulo-mpu6050-acelerometro-giroscopio-i2c.jpg" width="200px">|$65.00|1|
...
| 08 | VL53L0X  | 1.0.4| Líbreria python para el manejo del sensor lasér para distancia VL53L0X |
| 09 | mpu6050  | 1.0.1| Líbreria python para el manejo del sensor acelerometro mpu6050 |
